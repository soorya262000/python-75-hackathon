...
class cimage:
    def __init__(self,imgname):
        ...
        self.labtext=tk.Label(self.window,text="click the top left and bottom right points for cropping")
        self.labtext.pack(fill="x",side="top",expand=1)
        self.labitext=tk.Label(self.window)
        self.labitext.pack(fill="x",side="top",expand=1)        
    ...
    def mousepos(self,event):
          ...
          print(self.points)
          if len(self.points)==4:
              self.labitext.configure(text="click anywhere to continue")
